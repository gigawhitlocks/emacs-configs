...
*** Theme
I use [[https://github.com/kuanyui/moe-theme.el][moe theme]] which is absolutely the most full-featured Emacs theme I've ever seen.
It has a light variant and a dark variant, and both look fantastic, and has a feature for switching between light and dark themes at sundown automatically, which I use and greatly enjoy.
