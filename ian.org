...
2. Add a bookmarlet to rewrite https://bitbucket links to emacs:// links and send them to Emacs from Chrome or Firefox
3. Write some Emacs Lisp to detect URLs that pertain to local projects and open them directly in Emacs
