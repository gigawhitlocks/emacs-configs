...
#+BEGIN_SRC emacs-lisp
  (defun web ()
    ...
    (setq web-mode-engines-alist '(
            ("go" . ".*foo.party/themes/blank/.*\\.html\\'")
...
#+BEGIN_SRC emacs-lisp
  (defun post-config ()
    (use-package adaptive-wrap
      ...
      ;;; I originally wrote this hack for Go but I like it in a lot of modes
      ;;; this annoying comment is because I should move this stuff out of here
                                            'markdown-mode
                                            'go-mode-hook
                                            'js2-mode-hook
                                            'yaml-mode-hook
