- [Entrypoint](#org8a669df)
- [Package Manager Bootstrap](#org318dcc1)
- [Package Installation and Configuration](#org26aba36)
- [Extra Packages](#org3c36d58)
- [Font](#orgf394d8d)
- [Language Configuration](#org2e80833)
- [Adaptive Wrap and Visual Line Mode](#org406ec55)
- [Global Keybindings](#org90a9dba)
- [Org Mode Settings](#orgbb34985)
- [Miscellaneous standalone global configuration changes](#org2bc05a7)
- [Render this file for display on the web](#orgfbe284f)
  - [Update README.md git hook](#orgf2893d5)
- [Hostname-based tweaks](#org01ca81c)
- [Footer](#org43820e6)
  - [Start server](#orga8a51a6)
  - [End of file](#org29170da)
- [Styles for HTML export](#orge9ee0c6)
- [Launching Emacsclient](#orge4bdea4)
- [Running Emacs properly from the GUI](#org30d24f1)
- [Opening Code Links in Emacs](#orgdd1d062)
...
It's mostly used below in the [global keybindings](#org90a9dba) section.
...
-   Configure with a less-optimal method
    ...
    Now I can use that function to write a command that turns them on and off in the current buffer. I have this bound to `SPC t l` in the [Global Keybindings](#org90a9dba) section.
