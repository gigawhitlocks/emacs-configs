...
* Prologue
This is my Emacs configuration. It is written in [[https://orgmode.org/][Org Mode]] format, which means that I can display a static representation here, but the source repository and document, [[https://github.com/gigawhitlocks/emacs-configs][available on Github]], are interactive when opened in Emacs.
